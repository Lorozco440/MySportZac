    ...
    override fun onBindViewHolder(holder: RunsAdapter.MyViewHolder, position: Int) {
        ...
        when(run.medalDistance){
            "gold"->{
                ...
                holder.tvMedalDistanceTitle.setText(R.string.medalDistanceDescription)
            }
            "silver"->{
        ...
        when(run.medalAvgSpeed){
            "gold"->{
                ...
                holder.tvMedalAvgSpeedTitle.setText(R.string.medalAvgSpeedDescription)
            }
            "silver"->{
        ...
        holder.tvDelete.setOnClickListener{
            var id:String = usermail + run.date + run.startTime
            id = id.replace(":", "")
            id = id.replace("/", "")
